...
<script>
   ...
   //Load subcategory form
    ...
    //Delete subcategory after icon click
    $(document).off('click', '.deletesubcategorybtn').on('click', '.deletesubcategorybtn', function () {
            ...
            buttons: {
                ...
                yes: {
                    ...
                    action: function () {
                        $.ajax({
                            type: "POST",
                            url: "ajaxscripts/queries/delete/subcategory.php",
                            data: {
                                i_index: theindex
                            },
                            dataType: "html",
