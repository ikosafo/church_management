...
<script>
    ...
    //Load user table
    $.ajax({
        url: "ajaxscripts/tables/users.php",
        beforeSend: function () {
     ...
     //Edit user after icon click
     $(document).on('click', '.edituserbtn', function() {
        var id_index = $(this).attr('i_index');
        //alert(id_index);
            $.ajax({
                type: "POST",
                url: "ajaxscripts/forms/edituser.php",
                data: {
                    id_index: id_index
                },
                beforeSend: function () {
            ...
            buttons: {
                ...
                yes: {
                    ...
                    action: function () {
                        $.ajax({
                            type: "POST",
                            url: "ajaxscripts/queries/delete/user.php",
                            data: {
                                i_index: theindex
                            },
                            dataType: "html",
