...
<script>
   ...
   //Load giftcard form
    ...
    //Edit giftcard after icon click
    $(document).on('click', '.editgiftcardbtn', function() {
        var id_index = $(this).attr('i_index');
        //alert(id_index);
            $.ajax({
                type: "POST",
                url: "ajaxscripts/forms/editgiftcard.php",
                data: {
                    id_index: id_index
                },
                beforeSend: function () {
    ...
    //Delete giftcard after icon click
    $(document).off('click', '.deletegiftcardbtn').on('click', '.deletegiftcardbtn', function () {
            ...
            buttons: {
                ...
                yes: {
                    ...
                    action: function () {
                        $.ajax({
                            type: "POST",
                            url: "ajaxscripts/queries/delete/giftcard.php",
                            data: {
                                i_index: theindex
                            },
                            dataType: "html",
     ...
     $(document).on('click', '.viewgiftcardbtn', function() {
        var id_index = $(this).attr('i_index');
        //alert(id_index);
            $.ajax({
                type: "POST",
                url: "ajaxscripts/forms/viewgiftcard.php",
                data: {
                    id_index: id_index
                },
                beforeSend: function () {
