...
<script>
    ...
    //Load customer table
    $.ajax({
        url: "ajaxscripts/tables/customers.php",
        beforeSend: function () {
    ...
    //Edit customer after icon click
    $(document).on('click', '.editcustomerbtn', function() {
        var id_index = $(this).attr('i_index');
        //alert(id_index);
            $.ajax({
                type: "POST",
                url: "ajaxscripts/forms/editcustomer.php",
                data: {
                    id_index: id_index
                },
                beforeSend: function () {
    ...
    $(document).on('click', '.viewcustomerbtn', function() {
        ...
        //alert(id_index);
            $.ajax({
                type: "POST",
                url: "ajaxscripts/forms/viewcustomer.php",
                data: {
                    id_index: id_index
                },
                beforeSend: function () {
    ...
    //Delete customer after icon click
            ...
            buttons: {
                ...
                yes: {
                    ...
                    action: function () {
                        $.ajax({
                            type: "POST",
                            url: "ajaxscripts/queries/delete/customer.php",
                            data: {
                                i_index: theindex
                            },
                            dataType: "html",
