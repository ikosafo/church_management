...
$pinq = $mysqli->query("select * from website_testimony ORDER BY id DESC");
?>
<style>
    .dataTables_filter {
        display: none;
            ...
            <table id="datatable" class="table" style="margin-top: 3% !important;">
                ...
                while ($fetch = $pinq->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td><?php echo $fetch['testimony']; ?></td>
                        <td>
                            <button type="button"
                                    data-type="confirm"
                                    class="btn btn-danger delete_testimony"
...
<script>
    ...
    $(document).off('click', '.delete_testimony').on('click', '.delete_testimony', function () {
            ...
            buttons: {
                ...
                yes: {
                    ...
                    action: function () {
                        $.ajax({
                            type: "POST",
                            url: "ajax/queries/delete_testimony.php",
                            data: {
                                i_index: theindex
                            },
                            dataType: "html",
