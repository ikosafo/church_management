...
<form class="" autocomplete="off">
    ...
    <div class="kt-portlet__foot">
        <div class="kt-form__actions">
            <button type="button" class="btn btn-primary" id="saveprayerrequest">Submit</button>
...
<script>
    ...
    $('#page_image').uploadifive({
        ...
        'dnd': false,
        'uploadScript': 'ajax/queries/upload_prayerrequest_image.php',
    ...
    $("#saveprayerrequest").click(function () {
        ...
        if (error == "") {
            $.ajax({
                type: "POST",
                url: "ajax/queries/saveform_prayerrequest.php",
                beforeSend: function () {
                    KTApp.blockPage({
                        overlayColor: "#000000",
                        type: "v2",
                ...
                success: function (text) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "ajax/forms/prayerrequest_form.php",
                        beforeSend: function () {
                            KTApp.blockPage({
                                overlayColor: "#000000",
                                type: "v2",
                        ...
                        success: function (text) {
                            $('#prayerrequestform_div').html(text);
                        },
