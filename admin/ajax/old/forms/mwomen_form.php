...
<form class="" autocomplete="off">
    ...
    <div class="kt-portlet__foot">
        <div class="kt-form__actions">
            <button type="button" class="btn btn-primary" id="savewmwomen">Submit</button>
...
<script>
    ...
    $('#page_image').uploadifive({
        ...
        'dnd': false,
        'uploadScript': 'ajax/queries/upload_mwomen_image.php',
    ...
    $("#savewmwomen").click(function () {
        ...
        if (error == "") {
            $.ajax({
                type: "POST",
                url: "ajax/queries/saveform_mwomen.php",
                beforeSend: function () {
                    KTApp.blockPage({
                        overlayColor: "#000000",
                        type: "v2",
                ...
                success: function (text) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "ajax/forms/mwomen_form.php",
                        beforeSend: function () {
                            KTApp.blockPage({
                                overlayColor: "#000000",
                                type: "v2",
