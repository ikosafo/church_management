...
<form class="" autocomplete="off">
    ...
    <div class="kt-portlet__foot">
        <div class="kt-form__actions">
            <button type="button" class="btn btn-primary" id="savewdprotocol">Submit</button>
...
<script>
    ...
    $('#page_image').uploadifive({
        ...
        'dnd': false,
        'uploadScript': 'ajax/queries/upload_dprotocol_image.php',
    ...
    $("#savewdprotocol").click(function () {
        ...
        if (error == "") {
            $.ajax({
                type: "POST",
                url: "ajax/queries/saveform_dprotocol.php",
                beforeSend: function () {
                    KTApp.blockPage({
                        overlayColor: "#000000",
                        type: "v2",
                ...
                success: function (text) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "ajax/forms/dprotocol_form.php",
                        beforeSend: function () {
                            KTApp.blockPage({
                                overlayColor: "#000000",
                                type: "v2",
                    ...
                    $.ajax({
                        type: "POST",
                        url: "ajax/tables/dprotocol_table.php",
                        beforeSend: function () {
                            KTApp.blockPage({
                                overlayColor: "#000000",
                                type: "v2",
