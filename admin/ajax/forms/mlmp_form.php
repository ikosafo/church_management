...
<form class="" autocomplete="off">
    ...
    <div class="kt-portlet__foot">
        <div class="kt-form__actions">
            <button type="button" class="btn btn-primary" id="savewmlmp">Submit</button>
...
<script>
    ...
    $('#page_image').uploadifive({
        ...
        'dnd': false,
        'uploadScript': 'ajax/queries/upload_mlmp_image.php',
    ...
    $("#savewmlmp").click(function () {
        ...
        if (error == "") {
            $.ajax({
                type: "POST",
                url: "ajax/queries/saveform_mlmp.php",
                beforeSend: function () {
                    KTApp.blockPage({
                        overlayColor: "#000000",
                        type: "v2",
