...
<form class="" autocomplete="off">
    ...
    <div class="kt-portlet__foot">
        <div class="kt-form__actions">
            <button type="button" class="btn btn-primary" id="savewdevangelism">Submit</button>
...
<script>
    ...
    $('#page_image').uploadifive({
        ...
        'dnd': false,
        'uploadScript': 'ajax/queries/upload_devangelism_image.php',
    ...
    $("#savewdevangelism").click(function () {
        ...
        if (error == "") {
            $.ajax({
                type: "POST",
                url: "ajax/queries/saveform_devangelism.php",
                beforeSend: function () {
                    KTApp.blockPage({
                        overlayColor: "#000000",
                        type: "v2",
                ...
                success: function (text) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "ajax/forms/devangelism_form.php",
                        beforeSend: function () {
                            KTApp.blockPage({
                                overlayColor: "#000000",
                                type: "v2",
                        ...
                        success: function (text) {
                            $('#wdevangelismform_div').html(text);
                        },
