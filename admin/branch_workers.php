                ...
                <div class="kt-portlet__body">
                    <div class="kt-portlet__body">
                        ...
                        <div class="form-group row">
                            <label class="col-form-label col-lg-3 col-sm-12">Select Branch for <b>Branch Workers'</b> Details</label>
...
<script>
    ...
    $("#select_branch").change(function () {
        ...
        $.ajax({
            type: "POST",
            url: "ajax/tables/brworker_table.php",
            beforeSend: function () {
                KTApp.blockPage({
                    overlayColor: "#000000",
                    type: "v2",
