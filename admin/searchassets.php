                ...
                <div class="kt-portlet__body">
                    <div class="kt-portlet__body">
                        ...
                        <div class="form-group row">
                            <label class="col-form-label col-lg-3 col-sm-12">Select Branch to <b>Search for Assets</b></label>
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <div id="asscategorytable_div"></div>
                            </div>
                        </div>
...
<script>
    ...
    $("#select_branch").change(function () {
        ...
        $.ajax({
            type: "POST",
            url: "ajax/tables/assets_search.php",
            beforeSend: function () {
                KTApp.blockPage({
                    overlayColor: "#000000",
                    type: "v2",
