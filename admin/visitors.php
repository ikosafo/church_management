                ...
                <div class="kt-portlet__body">
                    <div class="kt-portlet__body">
                        ...
                        <div class="form-group row">
                            <label class="col-form-label col-lg-3 col-sm-12">Select Branch for <b>Visitor</b> Details</label>
                            ...
                            <div class=" col-lg-4 col-md-9 col-sm-12">
                                <select class="form-control kt-select2" id="select_branch" name="param">
                                    ...
                                    <?php
                                    $getvisitor = $mysqli->query("select * from branch ORDER BY name");
                                    while ($resvisitor = $getvisitor->fetch_assoc()){ ?>
                                        <option value="<?php echo $resvisitor['id'] ?>"><?php echo $resvisitor['name'] ?></option>
                                    <?php } ?>
