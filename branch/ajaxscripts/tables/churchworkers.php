...
<script>
    oTable = $('#table-data').DataTable({
        ...
        'serverMethod': 'post',
        'ajax': {
            url: "ajaxscripts/tables/pagination/churchworkers.php", // json datasource
        },
        'columns': [{
                data: 'fullname'
            },
    ...
    $(document).off('click', '.deleteworkerbtn').on('click', '.deleteworkerbtn', function() {
            ...
            buttons: {
                ...
                yes: {
                    ...
                    action: function() {
                        $.ajax({
                            type: "POST",
                            url: "ajaxscripts/queries/delete/churchworker.php",
                            data: {
                                i_index: theindex
                            },
                            dataType: "html",
