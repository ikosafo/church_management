...
?>
    ...
    <div class="table-responsive">
        <div class="kt-portlet__body">
            <table id="table-data" class="table" style="margin-top: 3% !important;">
                <thead>
                    <tr>
                        <th>Amount</th>
                        <th>Payment For</th>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo $restable['period']; ?></td>
                            <td>
                                <button type="button" data-type="confirm" class="btn btn-sm btn-danger js-sweetalert delete_paymentwelfare" i_index="<?php echo $restable['id'] ?>" title="Delete">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo $restable['period']; ?></td>
                            <td>
                                <button type="button" data-type="confirm" class="btn btn-sm btn-danger js-sweetalert delete_paymentff" i_index="<?php echo $restable['id'] ?>" title="Delete">
                                    <i class="flaticon2-trash ml-2" style="color: #fff !important;"></i>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo $restable['period']; ?></td>
                            <td>
                                <button type="button" data-type="confirm" class="btn btn-sm btn-danger js-sweetalert delete_paymentcontribution" i_index="<?php echo $restable['id'] ?>" title="Delete">
                                    <i class="flaticon2-trash ml-2" style="color: #fff !important;"></i>
                                </button>
                            </td>
                        </tr>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo $restable['period']; ?></td>
                            <td>
                                <button type="button" data-type="confirm" class="btn btn-sm btn-danger js-sweetalert delete_paymentmpartner" i_index="<?php echo $restable['id'] ?>" title="Delete">
                                    <i class="flaticon2-trash ml-2" style="color: #fff !important;"></i>
                                </button>
                            </td>
                        </tr>
