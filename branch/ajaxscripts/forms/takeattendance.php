...
$pinq = $mysqli->query("SELECT * FROM `members` WHERE branch = '$branch' ORDER BY fullname");
                                    ...
                                    <span style="width: 294px;">
                                        <div class="kt-user-card-v2">
                                            ...
                                            <div class="kt-user-card-v2__details">
                                                ...
                                                <span class="kt-user-card-v2__email"><?php echo $fetch['gender'] ?>, <?php echo $fetch['telephone'] ?></span>
                                            </div>
                                        </div>
                                    </span>
                                </td>
                                                ...
                                                <ul class="kt-nav">
                                                    ...
                                                    if (mysqli_num_rows($getstatus) == '1') { ?>
                                                        <li class="kt-nav__item">
                                                            <a class="kt-nav__link mark_absent" member_index="<?php echo $fetch['id'] ?>" href="#"> <i class="kt-nav__link-icon flaticon2-cross"></i>
                                                                <span class="kt-nav__link-text">Mark as Absent</span>
                                                            </a>
                                                        </li>
                                                    <?php } else { ?>
                                                        <li class="kt-nav__item">
                                                            <a class="kt-nav__link mark_present" member_index="<?php echo $fetch['id'] ?>" href="#"> <i class="kt-nav__link-icon flaticon2-check-mark"></i>
                                                    ...
                                                    ?>
                                                    <li class="kt-nav__item">
                                                        <a class="kt-nav__link view_member" member_index="<?php echo $fetch['id'] ?>" href="#"> <i class="kt-nav__link-icon flaticon2-file"></i>
