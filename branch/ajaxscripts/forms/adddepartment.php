    ...
    <div class="row">
        <div class="col-12">
            <div class="mb-1 row">
                ...
                <div class="col-sm-9">
                    <input type="text" id="departmentname" autocomplete="off" class="form-control" placeholder="Enter Department Name" />
                </div>
            </div>
        </div>

        <div class="col-sm-9 offset-sm-3">
            <button type="button" id="departmentbtn" class="btn btn-primary me-1">Submit</button>
        </div>
    </div>
</form>
...
<script>
    ...
    $("#departmentbtn").click(function() {
        ...
        if (error == "") {
            $.ajax({
                type: "POST",
                url: "ajaxscripts/queries/save/department.php",
                beforeSend: function() {
                    $.blockUI({
