                            ...
                            <div class="card-header">
                                <div>
                                    <h2 class="fw-bolder mb-0"> <?php
                                                                $getmem = $mysqli->query("select * from `members` where branch = '$branch'");
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div>
                                    <h2 class="fw-bolder mb-0">
                                        <?php
                                        $getcon = $mysqli->query("select * from `convert` where branch = '$branch'");
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div>
                                    <h2 class="fw-bolder mb-0">
                                        <?php
                                        $getcon = $mysqli->query("select * from `visitor` where branch = '$branch'");
                                        echo mysqli_num_rows($getcon);
                                        ?></h2>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div>
                                    <h2 class="fw-bolder mb-0">
                                        <?php
                                        $getmale = $mysqli->query("select * from `members` where gender = 'Male' and branch = '$branch'");
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div>
                                    <h2 class="fw-bolder mb-0">
                                        <?php
                                        $getfemale = $mysqli->query("select * from `members` where gender = 'Female' and branch = '$branch'");
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="card">
                            <div class="card-header">
                                <div>
                                    <h2 class="fw-bolder mb-0"> <?php
                                                                $getmem = $mysqli->query("select * from `members` where communicant = 'Yes' and branch = '$branch'");
                                                                echo mysqli_num_rows($getmem);
                                                                ?>
                                    </h2>
