...
<div class="form-group row">
    <div class="col-md-5">
        <p class="card-text font-small mb-2">
            Payment of First Fruit for <?php echo $result['fullname']; ?>
        </p>
        <hr />
        <form class="form form-horizontal" id="firstfruitform">
            <div class="row">
...
<script>
    ...
    $("#savepaymentbtn").click(function() {
        ...
        if (error == "") {
            $.ajax({
                type: "POST",
                url: "ajaxscripts/queries/save/payfirstfruit.php",
                beforeSend: function() {
                    $.blockUI({
                        message: '<h3 style="margin-top:6px"><img src="https://jquery.malsup.com/block/busy.gif" /> Just a moment...</h3>'
                    });
                ...
                success: function(text) {
                    ...
                    document.getElementById("firstfruitform").reset();
