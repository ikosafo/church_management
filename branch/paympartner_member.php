                ...
                <div class="kt-portlet__head">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title">
                            Payment of Partnership Dues for <?php echo $result['surname'] . ' ' .$result['firstname'] . ' ' .$result['othername'] ?>
                        </h3>
                    </div>
                </div>
                <!--begin::Form-->
...
<script>
    ...
    $("#savepaymentbtn").click(function () {
        ...
        var error = '';
        if (purpose == "") {
            error += 'Please enter purpose of payment \n';
            $("#purpose").focus();
        }
        if (amount == "") {
        ...
        if (error == "") {
            $.ajax({
                type: "POST",
                url: "ajax/queries/paympartner.php",
                beforeSend: function () {
                    KTApp.blockPage({
                        overlayColor: "#000000",
                        type: "v2",
