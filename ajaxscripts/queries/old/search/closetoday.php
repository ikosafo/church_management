...
<div class="row mt-1">
    <form style="display:hidden" name="hiddenForm" id="hiddenForm" method="post" action="exportcloseday.php">
        <input type="hidden" id="hiddenExportText" name="hiddenExportText">
    </form>
    <div class="col-sm-4">
        <button type="button" id="closebtn" onclick="printContent('printthis')" class="btn btn-block btn-primary">Print Details and Close for day</button>
    </div>

    <div class="col-sm-4">
        <button type="button" id="exportbtn" onclick="excel_export();" class="btn btn-block btn-secondary">Export to Excel</button>
    </div>
