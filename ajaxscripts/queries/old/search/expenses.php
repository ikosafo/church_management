...
<form style="display:hidden" name="hiddenForm" id="hiddenForm" method="post" action="exportexpenses.php">
...
<div class="row mt-1">
    ...
    <div class="col-sm-3">
        <button type="button" id="paybtn" onclick="excel_export();" class="btn btn-block btn-secondary">Export to Excel</button>
    </div>
