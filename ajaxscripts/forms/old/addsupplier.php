        ...
        <div class="row">
          ...
          <div class="row">
            <div class="mb-1 col-md-4">
              ...
              <input type="text" id="accnumber" class="form-control" placeholder="Account No." />
            </div>
            <div class="mb-1 col-md-4">
              <label class="form-label" for="accbalance">Store Account Balance</label>
              <input type="text" id="accbalance" class="form-control" placeholder="Store Account Balance" />
            </div>
            <div class="mb-1 col-md-4">
		      ...
		      <div class="row">
		        <div class="col-sm-12 offset-sm-12">
                    <button type="button" id="supplierbtn" class="btn btn-primary me-1">Submit</button>
                </div>
		    	</div>
    ...
    <script>
     ...
     $("#supplierbtn").click(function(){
      ...
      if (error == "") {
            $.ajax({
                type: "POST",
                url: "ajaxscripts/queries/save/supplier.php",
                beforeSend: function () {
