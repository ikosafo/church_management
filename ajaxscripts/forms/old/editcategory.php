...
$getdetails = $mysqli->query("select * from categories where catid = '$theid'");
...
<form class="form form-horizontal">
            ...
            <div class="col-sm-9 offset-sm-3">
                <button type="button" id="editcategorybtn" class="btn btn-warning me-1">Edit</button>
    ...
    // Edit action on form submit
     $("#editcategorybtn").click(function(){
      ...
      if (error == "") {
            $.ajax({
                type: "POST",
                url: "ajaxscripts/queries/edit/category.php",
                beforeSend: function () {
